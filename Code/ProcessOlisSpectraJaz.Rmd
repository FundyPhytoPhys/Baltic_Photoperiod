...
OLISSpectraFile <- "../Data/ImportedData/Baltic_Photoperiod_Imported_OlisSpectra.Rds"
...
```{r read Jaz file}
JazFile <- "../Data/ImportedData/Baltic_Photoperiod_Imported_JazEm.Rds"
...
```{r save rds}
# saveRDS(OLISSpectraMetaPUR, file.path(DataOut, paste(Project, "Processed_OlisSpectraAll.Rds", sep = "_"), fsep = .Platform$file.sep))

# saveRDS(OLISSpectraMetaPURShort, file.path(DataOut, paste(Project, "Processed_OlisSpectraPlot.Rds", sep = "_"), fsep = .Platform$file.sep))
```
...
```{r save rds}
saveRDS(OLISAllPURTidy, file.path(DataOut, paste(Project, "Processed_OlisSpectraTidy.Rds", sep = "_"), fsep = .Platform$file.sep))
```
