...
OLISSpectraMetaPURShortBA127R<- OLISSpectraMetaPUR %>%
  ...
  select(-c(PURNorm, FilenameJaz, FilenameOlis, PhotonDose))
...
```{r save rds}
saveRDS(OLISSpectraMetaPURShort, file.path(DataOut, paste(Project, "ProcessedOlisSpectra.Rds", sep = "_"), fsep = .Platform$file.sep))
```
