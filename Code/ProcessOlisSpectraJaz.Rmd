...
OLISSpectraFile <- "../Data/ImportedData/Baltic_Photoperiod_OlisSpectra.Rds"
...
```{r read Jaz file}
JazFile <- "../Data/ImportedData/Baltic_Photoperiod_JazEm.Rds"
...
```{r save rds}
saveRDS(OLISSpectraMetaAllPURShort, file.path(DataOut, paste(Project, "ProcessedOlisSpectra.Rds", sep = "_"), fsep = .Platform$file.sep))
```
