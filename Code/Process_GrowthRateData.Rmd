...
```{r}
saveRDS(MultiCultiGrowthRatePURExpFitok, file.path(RDSPlotPath, paste(Project, "Plot_Growthrate_1.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
...
```{r save rds}
saveRDS(MultiCultiGrowthRatePURExp, file.path(DataOut, paste(Project, "Procesed_GrowthRate.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```

# Removed unneccessary df from the environment

```{r}
rm(MultiCultiGrowthRatePURExpFit30, MultiCultiGrowthRatePURExpFit90, MultiCultiGrowthRatePURExpFit180, MultiCultiGrowthRatePURExpFit300, MultiCultiGrowthRatePURExpFit900, GRCplatt_PredictGrowth30, GRCplatt_PredictGrowth90, GRCplatt_PredictGrowth180, GRCplatt_PredictGrowth300, GRCplatt_PredictGrowth900, OLISSpectra, MultiCultiGrowth, MultiCultiGrowthRate, CleanGrowthPARPURfit, CleanGrowthPARPURfit900, GRCplatt_PredictGrowth, MultiCultiDataCleanGrowthAll2, MultiCultiDataCleanGrowthAll3, MultiCultiDataCleanGrowthAll4, MultiCultiGrowthRatePURExpFit, MultiCultiGrowthRatePURExpFitok)
```
