...
```{r}
MultiCultiPigmentMaxAllChlaPhyco1<-MCPigment %>% 
...
```{r test pigments per cell plot, fig.height = 8, fig.width = 8}
...
MultiCultiPigmentMaxAllChlaPhyco %>%
  ggplot() +
...
MultiCultiPigmentMaxAllChlaPhyco %>%
  ...
  ggplot() +
  geom_point(aes(x = Time_h, y = Pigmentspgcell, colour = as.factor(PigmentsName)), alpha = 0.9, size = 3, show.legend = T) +
