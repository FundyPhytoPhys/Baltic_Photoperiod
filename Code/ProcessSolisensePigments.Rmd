...
# Also, conteined mean for sig - mean for replica measured on the same day
...
```{r}
SolFitsAllChoosen2<- SolFitsChoosen 
...
potrzebne pigmenty - phyco/chla ratio!!!!
