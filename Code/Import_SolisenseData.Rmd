...
# Calculate Sigma mean from replica measured on the same day

```{r calculate Sigma mean, warning = FALSE, echo=FALSE}

SolFitsTrimMetaCleanOS <- SolFitsTrimMetaCleanOS %>%
  group_by(SampleID, Ex_WL, ObsDate, Par_ue, Photoperiod, WL, O2) %>%
  summarize(SolFitsTrimMetaCleanOS, 
...
# Calculate Sigma1s mean from replica measured on the same day

```{r Calculate Sigma1s mean}
SolFitsTrimMetaDarkafterLightOS <- SolFitsTrimMetaDarkafterLightOS %>%
  group_by(SampleID, Ex_WL, ObsDate, Par_ue, Photoperiod, WL, O2) %>%

  summarize(SolFitsTrimMetaDarkafterLightOS,
...
SampleID"                   "Run"                        "Strain"                    
 ...
 [7] "MC"                         "Tube"                       "O2"                        
[10] "WL"                         "LightShape"                 "ExpEndDate"                
[13] "PARPhotonDose_day"          "Time__mSec"                 "Dur-Wat"                   
[16] "ChiSq"                      "QARredMax"                  "Sig"                       
[19] "Fo"                         "Fm"                         "p"                         
[22] "Tau1QA"                     "Tau2QA"                     "Tau3QA"                    
[25] "Tau4QA"                     "Alp1QA"                     "Alp2QA"                    
[28] "Alp3QA"                     "Alp4QA"                     "Alpha"                     
[31] "Ek"                         "Pmax"                       "Fv"                        
[34] "Filename"                   "ObsDate"                    "ObsTime"                   
[37] "ObsDateTime"                "Step_s"                     "Dark1s"                    
[40] "Ex_WL"                      "ActPAR"                     "LR_s"                      
[43] "StartDateTimeSol"           "nm445"                      "nm470"                     
[46] "nm505"                      "nm535"                      "nm590"                     
[49] "IR"                         "TempCont"                   "FvFm"                      
[52] "nm445Corr"                  "nm470Corr"                  "nm505Corr"                 
[55] "nm535Corr"                  "nm590Corr"                  "IRCorr"                    
[58] "ActPARCorr"                 "Sig_m2psii"                 "Fodark"                    
[61] "Fmdark"                     "Sigdark"                    "Sigdark_m2psii"            
[64] "ActPARCorr_photonsm2s"      "TauAv"                      "Ctauav"                    
[67] "aLHIIdark"                  "Fomin"                      "Fmmax"                     
[70] "Sigmax"                     "Sigmax_m2psii"              "FoOxbo"                    
[73] "qpOxbo"                     "aLHIIOxbomax"               "JVPSII_aLHIIOxbomax"       
[76] "ETRCtauav"                  "ETRqpOxbo"                  "JVPSII_ETRtauav_FoSig"     
[79] "JVPSII_ETRqpOxbo_FoSig"     "JVPSII_ETRtauav_aLHII_Sig"  "JVPSII_ETRqpOxbo_aLHII_Sig"
[82] "Sig_nm2psii"                "Sigdark_nm2psii"           
...
SolFitsTrimMetaCleanNS <- SolFitsTrimMetaCleanNS %>%
  ...
  summarize(SolFitsTrimMetaCleanNS, 
...
```{r calculate Sigma1s mean, warning = FALSE, echo=FALSE}
SolFitsTrimMetaDarkafterLightNS <- SolFitsTrimMetaDarkafterLightNS %>%
  group_by(SampleID, Ex_WL, ObsDate, Par_ue, Photoperiod, WL, O2) %>%

  summarize(SolFitsTrimMetaDarkafterLightNS,
