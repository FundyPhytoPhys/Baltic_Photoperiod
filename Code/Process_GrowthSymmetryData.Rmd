...
GScatalogMeta %>%
  ...
  geom_hline(data = data_hlineGS8, aes(yintercept = value), linetype="dashed", size=0.4) +
  geom_hline(data = data_hlineGS12, aes(yintercept = value), linetype="dashed", size=0.4) +
