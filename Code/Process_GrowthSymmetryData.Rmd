...
data_text_alpha<- data.frame(facetsPhase = c("Phase~of~growth", "Phase~of~growth"), Phase = c("Exponential"), facetsStrain=c("Strain", "Strain", "Strain", "Strain"), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('\u03B1 = 3.4', '\u03B1 = 1.7', '\u03B1 = 1.2', '\u03B1 = 2.1'))
...
lab2=c(expression("30 µE"), expression("90 µE"), expression("180 µE"), expression("300 µE"), expression("900 µE"))
  ...
  geom_text(data=data_text_alpha, aes(x=24000000, y=2.4, label=label), size=3.5) +
