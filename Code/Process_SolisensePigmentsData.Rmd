...
SolFitsExpSt24 %>% 
  ...
  geom_errorbar(aes(x = PARPhotonDose_day, ymin = AllmeanSig_nm2psii - AllsdSig_nm2psii, ymax = AllmeanSig_nm2psii + AllsdSig_nm2psii, colour=as.factor(Par_ue)), width=0, size=0.3) +
  #scale_shape_manual(values = c(15, 16, 17,18), name="", labels = lab1) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "orange1"), name="", labels = lab2) +
...
SolFitsExpFitAll<-SolFitsExpFitAll %>% 
  filter(Ex_WL!=445) 
...
ggplot(SolFitsExpFitAll, aes(x = PARPhotonDose_day, y = Sig_nm2psii)) +
  ...
  geom_line(aes(PARPhotonDose_day, .fitted), show.legend = F, augmented) +
