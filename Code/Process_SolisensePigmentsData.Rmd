...
SolFitsExpFit590<-rbind(Sol1, Sol2, Sol3, Sol4, Sol5, Sol6)
SolFitsExpFitAll<-rbind(Sol1, Sol2, Sol3, Sol4, Sol5, Sol6, Sol7)

rm(Sol1, Sol2, Sol3, Sol4, Sol5, Sol6, Sol7)
```
...
data_text_lambda<- data.frame(WL = c("WW", "WW"), Ex_WL = c(590), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('\u03BB = 2.8', '\u03BB = 2.6', '\u03BB = 1.9', '\u03BB = 3.6'))
data_text_lambda<-data_text_lambda %>% 
  mutate(Ex_WL=as.factor(Ex_WL))
