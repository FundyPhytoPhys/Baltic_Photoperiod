...
```{r Load df with calculated Par_ue sine per hour}
gs4_deauth()
...
rm(data_hlineGS8, data_hlineGS12, data_hlineGS16, GSMetaSt, augmented, fitted, GScatalog, GScatalogMetaExp, GSMetaExp, MetaData, data_vline_048, data_vline_127, data_vline_056, data_vline_077, ParSine, GSMetaExpPlot, GScatalogSine, GScatalogMetaFinalPlot, GScatalogSineMeta)
```
