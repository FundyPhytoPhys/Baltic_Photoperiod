...
# load local GS catalog containg tMaxAG values and create 4 df for vertical lines
...
```{r save rds}
# saveRDS(MCPigmenttMaxAG, file.path(DataOut, paste(Project, "Processed_MCPigmentAll.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
