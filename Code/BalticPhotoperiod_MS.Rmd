...
knitr::include_graphics(file.path( FiguresFP,"AbsoluteGrowth.png"))   #XXXXRemovve Absolute growth increment, replace through out with First Derivative (hourly)
```
...
CellSize_cap<- glue("Representative photograph of two PhycoCyanin(PC)-rich cultures (Culture Collection of Baltic Algae; 056, 077) and two PhycoErythrin(PE)-rich (Culture Collection of Baltic Algae; 048, 127) *Synechococcus* sp. strains together with a diagram showing the cell size calculation procedure. Bar denotes 10 μm.", .sep = " ")
